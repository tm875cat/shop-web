    ...
    <div class="apply_page">
        ...
        <div class="main_page" v-if="!applyFinish">
            ...
            <div class="apply_input">
                <input type="text" v-model="inputName" :placeholder="inputNamePlaceholder" @click="resetNameError()"
                    :class="{ error: inputNameError }" />
                <input type="text" v-model="inputEmail" :placeholder="inputEmailPlaceholder"
                    @input="inputEmail = filterEnglishSymbols($event.target.value)" @click="resetEmailError()"
                    :class="{ error: inputEmailError }" />
                <input type="text" v-model="inputPsw" :placeholder="inputPswPlaceholder"
                    @input="inputPsw = filterEnglishSymbols($event.target.value)" @click="resetPswError()"
